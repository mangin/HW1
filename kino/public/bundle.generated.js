...
//    '.'.split(/()()/) should be ["."], not ["", "", "."]
            ...
            if (
                ...
                (function () {
                    var compliantExecNpcg = typeof (/()??/).exec('')[1] === 'undefined'; // NPCG: nonparticipating
                                                                                         // capturing group
...
//    '.'.split(/()()/) should be ["."], not ["", "", "."]
                    ...
                    if (
                        ...
                        (function () {
                            var compliantExecNpcg = typeof (/()??/).exec('')[1] === 'undefined'; // NPCG:
                                                                                                 // nonparticipating
                                                                                                 // capturing group
...
// ES-5 15.1.2.2
                            ...
                            1: [function (require, module, exports) {
                                ...
                                (function e (t, n, r) {
                                    ...
                                    1: [function (require, module, exports) {
                                        ...
                                        'use strict';
                                        var Query = require("../cinema/simpleResolver").Query;
                                        console.log(new Query().toArray());
                                    }, {"../cinema/simpleResolver": 1}]
                                }, {}, [2]);

                            }, {"../cinema/simpleResolver": 1}], 3: [function (require, module, exports) {
                                'use strict';
                                var Query = require("../cinema/simpleResolver").Query;
                                console.log(new Query().toArray());
                            }, {"../cinema/simpleResolver": 1}]
                    ...
                    }, {"../cinema/simpleResolver": 1}], 4: [function (require, module, exports) {
                        'use strict';
                        var Query = require("../cinema/simpleResolver").Query;
                        require("es5-shim");
                        console.log(new Query().toArray());
                    }, {"../cinema/simpleResolver": 1, "es5-shim": 2}]
                }, {}, [3, 4]);

            }, {"../cinema/simpleResolver": 1, "es5-shim": 2}], 4: [function (require, module, exports) {
                'use strict';
                require("es5-shim");
                var Query = require("../cinema/simpleResolver").Query;
                console.log(new Query().toArray());
